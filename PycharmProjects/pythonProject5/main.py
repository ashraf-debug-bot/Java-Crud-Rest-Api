...
class HandRecog:
    ...
    def set_finger_state(self):
        ...
        for idx ,point in enumerate(points):
            ...
            try:
                ratio = round(dis t /dist2 ,1)
            except:
                ratio = round(dist 1 /0.01 ,1)
...
class Controller:
    ...
    def changesystembrightness():
        ...
        currentBrightnessLv += Controller.pinchl v /50.0
        if currentBrightnessLv > 1.0:
            currentBrightnessLv = 1.0
        elif currentBrightnessLv < 0.0:
            currentBrightnessLv = 0.0
        sbcontrol.fade_brightness(int(10 0 *currentBrightnessLv) , start = sbcontrol.get_brightness(display=0))
    ...
    def changesystemvolume():
        ...
        currentVolumeLv += Controller.pinchl v /50.0
    ...
    def scrollVertical():
        ...
        pyautogui.scroll(120 if Controller.pinchl v >0.0 else -120)
